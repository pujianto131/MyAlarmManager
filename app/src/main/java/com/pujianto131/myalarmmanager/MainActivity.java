...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btnOneTimeDate, btnOneTimeTime, btnOneTime, btnRepeatingTime, btnRepeating,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOneTime = (Button) findViewById(R.id.btn_set_one_time_alarm_);
        ...
        if (v.getId() == R.id.btn_one_time_alarm_date){
            ...
            new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
                ...
                public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMont) {
                    ...
                    calOneTimeDate.set(year, monthOfYear, dayOfMont);
            ...
            final Calendar currenDate = Calendar.getInstance();
            ...
            }, currenDate.get(Calendar.HOUR_OF_DAY), currenDate.get(Calendar.MINUTE), true).show();
        }

        else if (v.getId() == R.id.btn_set_one_time_alarm_){
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
            String oneTimeDate = dateFormat.format(calOneTimeDate.getTime());

            SimpleDateFormat timFormat = new SimpleDateFormat("HH:mm");
            String onTimeTime = timFormat.format(calOneTimeTime.getTime());
            ...
            alarmPreference.setOneTimeTime(onTimeTime);
